...
class Release(object):
    ...
    def packZip(self):
        ...
        if os.path.exists('source/additional'):
            subprocess.call('powershell robocopy %s %s %s /COPYALL' %(os.path.realpath('source/additional'), os.path.realpath(self.versionPath), '*.wotmod') )
