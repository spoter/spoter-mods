...
from gui.mods.mod_mods_gui import g_gui, inject as p__inject
...
class MapsData(object):
    def __init__(self):
        self.data = {
            '00_tank_tutorial'     : ([], []),
            '01_karelia'           : ([(-38.7174, 20.6221, 3.88532), (-62.323, 21.1302, -64.2737), (-484.587, 41.6859, -39.0637), (277.149, 39.0939, 189.29), (287.932, 54.9766, 412.636), (167.194, 41.5668, 351.833)], [(-38.7174, 20.6221, 3.88532), (-62.323, 21.1302, -64.2737), (-484.587, 41.6859, -39.0637), (-485.664, 65.4323, -469.358), (-429.249, 35.6641, -152.877), (277.149, 39.0939, 189.29), (287.932, 54.9766, 412.636), (167.194, 41.5668, 351.833), (-116.654, 20.325, -22.963)]),
            '02_malinovka'         : ([(-87.4027, 9.79008, -28.7285), (11.8839, 9.93128, -144.129), (-260.851, 9.77789, -405.307), (158.749, 16.6823, -27.0007), (175.761, 19.4496, 65.8675), (139.739, 25.1161, 149.679), (421.953, 55.5026, 301.764)], [(-124.134, 9.59206, 7.44205), (-90.9091, 9.82202, -27.7949), (-249.638, 9.07871, -22.1089), (-120.229, 14.4694, 157.536), (-314.215, 9.33623, -238.975), (0.0066656, 21.3506, 188.668), (133.746, 25.163, 163.649), (339.175, 55.3964, 380.807)]),
            '04_himmelsdorf'       : ([], []),
            '05_prohorovka'        : ([(-344.214, 9.90543, 73.9396), (-495.056, 21.9927, 39.8306), (-461.423, 13.7267, 38.0076), (33.3768, 10.228, 39.3744), (31.4288, 10.6367, -6.57884), (326.377, 10.0794, 8.4657), (466.592, 30.7791, -102.303), (472.715, 32.018, -77.1577)], [(-338.711, 10.5767, -96.6661), (-495.83, 18.795, -125.446), (-495.534, 21.9519, 35.8387), (40.3161, 10.1472, -17.019), (208.74, 9.9951, -26.0816), (230.982, 9.70868, -64.6931), (500.084, 37.1061, -196.039)]),
            '06_ensk'              : ([], []),
            '07_lakeville'         : ([(-80.069, 6.41545, 78.2053), (179.73, -4.8691, 150.418), (141.34, -4.91541, 9.93952), (134.608, -5.00138, -28.1786), (118.469, 14.0239, -367.363), (-317.537, 22.5343, -10.3654), (-344.361, 8.77602, 282.413), (17.7711, 7.2991, 369.066), (-265.335, 15.0933, 326.87)], [(-78.5001, 7.1412, -67.6482), (107.257, -4.84451, -122.466), (139.031, -4.97592, 64.8037), (-17.5822, 6.63461, 293.195), (7.99448, 8.94406, -371.503), (-317.447, 23.3271, -13.9052), (-306.809, 11.7696, -296.899), (147.594, -4.78767, -92.2459)]),
            '08_ruinberg'          : ([], []),
            '10_hills'             : ([(279.34, 25.2322, 187.455), (180.673, 19.794, 216.029), (-338.968, 7.8405, -207.874), (-326.886, 12.1465, 3.33471), (29.4907, 27.6254, 110.743), (9.95471, 27.8499, 103.174)], [(74.4703, 30.1248, -76.3657), (-309.91, 10.983, -43.5275), (-241.558, 1.54507, -5.77622)]),
            '63_tundra'            : ([], []),
            '73_asia_korea'        : ([], []),
            '83_kharkiv'           : ([], []),
            '84_winter'            : ([(12.4407, 6.48786, 132.69)], [(-80.9593, 7.58463, 107.072)]),
            '86_himmelsdorf_winter': ([], []),
            '92_stalingrad'        : ([], []),
            '95_lost_city'         : ([], []),
            '96_prohorovka_defense': ([(-344.214, 9.90543, 73.9396), (-495.056, 21.9927, 39.8306), (-461.423, 13.7267, 38.0076), (33.3768, 10.228, 39.3744), (31.4288, 10.6367, -6.57884), (326.377, 10.0794, 8.4657), (466.592, 30.7791, -102.303), (472.715, 32.018, -77.1577)], [(-338.711, 10.5767, -96.6661), (-495.83, 18.795, -125.446), (-495.534, 21.9519, 35.8387), (40.3161, 10.1472, -17.019), (208.74, 9.9951, -26.0816), (230.982, 9.70868, -64.6931), (500.084, 37.1061, -196.039)]),
            '100_thepit'           : ([], []),
            '101_dday'             : ([], []),
            '103_ruinberg_winter'  : ([], []),
            '112_eiffel_tower_ctf' : ([(-132.88, 6.64391, 216.893), (-228.697, 10.0129, 141.979), (-131.821, 9.18746, 16.7217), (-349.143, 7.48962, 41.3225)], [(117.16, 5.99205, 253.052), (-3.94333, -0.925388, 355.432), (73.5, 9.03571, -14.6004), (320.302, 7.79187, 50.6466), (215.655, 9.8497, 139.428)]),
            '114_czech.pkg'        : ([], []),
        }
...
class spotMarks(object):
    ...
    def startBattle(self):
        ...
        if config.data['showOnlyLightTanks'] and Vehicle.getVehicleClassTag(self.player.vehicleTypeDescriptor.type.tags) != VEHICLE_CLASS_NAME.LIGHT_TANK: return
        ...
        if self.mapSelected and self.mapSelected in mapsData.data:
            teamBase = self.player.guiSessionProvider.getArenaDP().getNumberOfTeam()
            teamBase -= 1
            if mapsData.data[self.mapSelected][teamBase]:
                for position in mapsData.data[self.mapSelected][teamBase]:
    ...
    def checkBattleStarted(self):
        if hasattr(self.player, 'arena') and self.player.arena.period is 3:
            ...
            if config.data['showBattleGreetings'] and self.battleStarted:
                ...
                p__inject.message(message, color)
        else:
    ...
    def createModel(self, position):
        ...
        arrowModel = p__StaticObjectMarker3D(arrow, position)
        groundModel = p__StaticObjectMarker3D(ground, position)
        ...
        if g_appLoader.getDefBattleApp():
            ...
            if g_gui.get_key(config.buttons['buttonMark']) and event.isKeyDown():
                if self.player:
                    ...
                    print '"%s": ([%s], [%s])' % (self.mapSelected, position if not teamBase else '', position if teamBase else '')
                    p__inject.message(message)
...
@p__inject.hook(PlayerAvatar, '_PlayerAvatar__startGUI')
@p__inject.log
...
@p__inject.hook(PlayerAvatar, '_PlayerAvatar__destroyGUI')
@p__inject.log
...
@p__inject.hook(game, 'onGeometryMapped')
@p__inject.log
