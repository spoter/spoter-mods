...
class Release(object):
    ...
    def __init__(self, build, zip):
        ...
        self.versionPath = os.path.join(self.modsPath, self.data.CLIENT_VERSION, 'b4it')
        self.configPath = os.path.join(self.modsPath, 'configs', 'b4it', os.path.splitext(os.path.basename(self.data.build.VERSION["config"]))[0])
